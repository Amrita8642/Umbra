...
After 500 episodes, 54% Arms Race defender resistance, and a Cialdini Stress Test across all 7 influence principles — here's what the agent learned to do:

| Metric | Easy | Medium | Hard | Verdict |
|--------|------|--------|------|---------|
| Deception Catch Rate | 0.43 | 0.57 | **0.67** | Gets sharper under more pressure ✅ |
| Coalition Detection | 0.42 | 0.41 | **0.66** | Doubles when it matters most ✅ |
| Calibration Score | 0.78 | 0.69 | **0.80** | Stays honest across difficulties ✅ |
| Avg Episode Reward | 1.94 | 3.89 | **5.57** | Thrives in harder environments ✅ |

**The headline:** The agent doesn't just survive harder scenarios — it performs *better* in them. Pressure activates its scrutiny.
